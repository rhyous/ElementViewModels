var ButtonViewModel = function(text, clickMethod, canClickMethod, autoEnableButtonAfterOnClick) {
  // Private
  var _self = this;
  BaseElement(_self);
  var _text = text;
  ...
  var _autoEnableButtonAfterOnClick = (autoEnableButtonAfterOnClick) && autoEnableButtonAfterOnClick;
