loader("NumberColumn", ["ElementModels/ColumnModel"],
    function (ColumnModel) {
        var NumberColumn = function(index, text, datafield, child) {
            var _self = this;
            var _index = index;
            var _text = text;
            ...
            _self.init = function(obj) {
                obj.base = new ColumnModel(_index, _text, _dataField, "Number", _sortMethod, null, _self);
            };
            _self.init(_self);
